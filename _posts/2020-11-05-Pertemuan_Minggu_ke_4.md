---
layout: post
title:  "Program Aplikasi Database Menggunakan Java Netbeans & MYSQL || Pertemuan Minggu Keempat"
author: Mapriyatna
categories: [ Tutorial ]
image: assets/images/nx.png
---

#### *Membuat Program Aplikasi Database  dengan Java Netbeans & MySQL || Pertemuan Minggu ke 4*
##### *Muhamad Apriyatna 181011401125*

Pada pertemuan ini, saya akan membagikan sedikit tutorial bagaimana cara membuat program aplikasi Database input data yang terdiri dari : 
- ID Kontak
- Nama Kontak
- No. Kontak
- Alamat
...
**Serta membut button *melihat, mencari, menghapus, dan mengupdate data kontak.***
...
**Kita beralih ke Netbeans IDE**, buat project baru dengan cara File → New Project → Java Application → Next. lalu nama project "PertemuanMingguke4" dan "Finish".

Dalam Source Package kita buat baru *jFrame From...* dengan nama (disini saya isikan) **"MuhamadApriyatna_Mingguke4"**, lalu Finish.
...
Pada *jFrame* "MuhamadApriyatna_Mingguke4" kita buat desain seperti ini.
![](/assets/images/p4_2.png).

**Note** *Dengan 6 Label, 4 TextField, 1 ComboBox, 8 Button, dan 1 Table yang ada pada Swing Controls, dan jangan lupa atur properties dan nama variable nya ;)*.
